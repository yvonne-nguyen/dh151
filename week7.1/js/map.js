...
let geojsonPath = 'data/SJJoined.geojson';
let geojson_data;
...
function createMap(lat,lon,zl){
	...
	L.marker([37.33423132986001, -121.90436098456495]).addTo(map);
}
...
function getGeoJSON(){
	...
	$.getJSON(geojsonPath,function(data){
		...
		mapGeoJSON('sccmfi1990_MFI1990', 6, "Oranges", 'equal_interval') // add a field to be used
	})
}
